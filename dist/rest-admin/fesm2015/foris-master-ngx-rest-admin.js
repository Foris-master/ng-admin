                    ...
                    if (this.resource.detailConfig.tabsConfig &&
                            ...
                            tab.datas.forEach((elt) => {
                                ...
                                switch (temp[search.name].restField.type) {
                                    ...
                                    case REST_FIELD_TYPES.BELONG_TO_MANY:
                                        ...
                                        break;
                                    case REST_FIELD_TYPES.BELONG_TO:
                                        const belongVal = (_p = (_o = search.metaData) === null || _o === void 0 ? void 0 : _o.detailConfig) === null || _p === void 0 ? void 0 : _p.belongToSecondFieldLabel.split('.');
                                        let dat = response;
                        ...
                        this.resource.fields.forEach((elt) => {
                            ...
                            if (elt.type === REST_FIELD_TYPES.BELONG_TO) {
                                const belongVal = (_b = (_a = elt.metaData) === null || _a === void 0 ? void 0 : _a.detailConfig) === null || _b === void 0 ? void 0 : _b.belongToSecondFieldLabel.split('.');
                                let dat = response;
                                if (belongVal && (belongVal === null || belongVal === void 0 ? void 0 : belongVal.length) > 0) {
                                    belongVal.forEach((val) => {
                                        dat = dat[val];
