(function (global, factory) {
    ...
    ***************************************************************************** */
            ...
            get: function () {
                ...
                try {
                    ...
                    if (this.restField.i18n === true && this.restField.metaData && this.restField.metaData.addConfig.jsonConfig) {
                        var selectedField = this.restField.metaData.addConfig.jsonConfig.jsonFields.find(function (field) { return field === _this.langService.selected; });
                        if (selectedField) {
            ...
            if (typeof value == 'string') {
                if (!this.options[field.name]) {
                    ...
                    return this.options[field.name].filter(function (optionValue) {
                        return field.metaData.addConfig.belongToOptions.filterKeys.some(function (elt) {
                            var _a;
                    ...
                    if (search && formData[key] !== undefined) {
                        switch (search.type) {
                            ...
                            case exports.REST_FIELD_TYPES.BOOLEAN:
                                ...
                                break;
                            case exports.REST_FIELD_TYPES.IMAGE:
                                if (formData[key] !== null && _this.isFile(formData[key]))
                                    datas.append(key, formData[key]);
                                break;
                            case exports.REST_FIELD_TYPES.PDF:
                                if (formData[key] !== null && _this.isFile(formData[key]))
    ...
    var RestResourceDetailComponent = /** @class */ (function () {
        function RestResourceDetailComponent(activatedRoute, serviceRest, serviceRestAdminConfig, router, dataSourceBuilder, dialogService, langService) {
            var _this = this;
            this.activatedRoute = activatedRoute;
            this.serviceRest = serviceRest;
            this.serviceRestAdminConfig = serviceRestAdminConfig;
                ...
                try {
                    ...
                    if (val.restField.i18n === true) {
                        if (typeof val.data === 'string' && val.data[0] === '{') {
                            var parsedData = JSON.parse(val.data);
                            if (parsedData[_this.langService.selected]) {
                                _jsonValue = parsedData[_this.langService.selected];
                            }
                            else {
                                throw new Error('Invalid i18n language selected');
                            }
                        }
                        else if (typeof val.data === 'object' && val.data[_this.langService.selected]) {
        ...
        RestResourceDetailComponent.prototype.deleteEntity = function () {
            var _this = this;
            ...
            dialog.onClose.subscribe(function (resp) {
                if (resp) {
                    _this.router.navigateByUrl("/admin/" + _this.ressourceName + "-list");
                }
            });
        };
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.5", ngImport: i0__namespace, type: RestResourceDetailComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace.ActivatedRoute }, { type: RestResourceService }, { type: RestAdminConfigService }, { type: i1__namespace.Router }, { type: i1__namespace$1.NbTreeGridDataSourceBuilder }, { type: i1__namespace$1.NbDialogService }, { type: RestLangService }]; }, propDecorators: { resource: [{
                    type: i0.Input
                }], ID: [{
                    type: i0.Input
                }], ressourceName: [{
    ...
    var RestResourceListComponent = /** @class */ (function () {
        ...
        RestResourceListComponent.prototype.selectFilterBy = function (data, index) {
            var _this = this;
            var _a;
            ...
            if (data['value'] === 'id') {
                var resource = (_a = data === null || data === void 0 ? void 0 : data.resource) === null || _a === void 0 ? void 0 : _a.addConfig;
                this.serviceRestResources
                    .getResources({
                    api: resource.api,
                    queryParams: {
                    ...
                    .subscribe(function (response) {
                    _this.options[data['value']] = __spreadArray([], __read(response)).sort(function (x, y) {
                        var _a;
                        return (_a = x['id']
                            .toString()
                            .toLowerCase()) === null || _a === void 0 ? void 0 : _a.localeCompare(y['id'].toString().toLowerCase());
                    });
                    _this.allFilterContains[data['value']] = rxjs.of(_this.options[data['value']]);
                });
            }
        };
        ...
        RestResourceListComponent.prototype.filterMany = function (value, index, options) {
            var _this = this;
            if (options === void 0) { options = 'belongToManyOptions'; }
            var _a;
            if (typeof value == 'string' && ((_a = this.options['id']) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                return this.options['id'].filter(function (optionValue) {
                    return [
                        _this.searchItems[index].fieldName
                            ? _this.searchItems[index].fieldName
                            : 'id',
                    ].some(function (elt) {
                        var _a;
        ...
        RestResourceListComponent.prototype.getFilteredOptions = function (value, index) {
            var _this = this;
            return rxjs.of(value).pipe(operators.map(function (filterString) { return _this.filterMany(filterString, index); }));
        };
        RestResourceListComponent.prototype.filterInput = function (event, index) {
        ...
        RestResourceListComponent.prototype.startSearch = function () {
            ...
            this.searchItems.forEach(function (element, ind) {
                ...
                if ((element === null || element === void 0 ? void 0 : element.field) === 'id') {
                    ...
                    if (tab.length > 0) {
                        var listId = tab.map(function (elt) { return elt === null || elt === void 0 ? void 0 : elt.id; }).join(',');
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.5", ngImport: i0__namespace, type: RestResourceListComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i1__namespace$4.FormBuilder }, { type: RestAdminConfigService }, { type: RestResourceService }, { type: i1__namespace$2.HttpClient }, { type: i1__namespace$1.NbDialogService }, { type: i1__namespace.ActivatedRoute }, { type: i1__namespace.Router }, { type: i1__namespace$1.NbMenuService }, { type: RestExportService }, { type: RestShareService }]; }, propDecorators: { resource: [{
                    type: i0.Input
                }], search: [{
                    type: i0.ViewChild,
                    args: ['search']
    ...
    var FooterComponent = /** @class */ (function () {
        function FooterComponent(serviceRestAdmin) {
            this.serviceRestAdmin = serviceRestAdmin;
        }
        return FooterComponent;
    }());
    FooterComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.5", ngImport: i0__namespace, type: FooterComponent, deps: [{ token: RestAdminConfigService }], target: i0__namespace.ɵɵFactoryTarget.Component });
