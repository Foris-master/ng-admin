(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var RestResourceAddComponent = /** @class */ (function () {
        ...
        RestResourceAddComponent.prototype.onSelectionChange = function (event, field) {
            ...
            this.belongToValue[field.name] = bVal
                ? bVal[((_b = (_a = field === null || field === void 0 ? void 0 : field.metaData) === null || _a === void 0 ? void 0 : _a.addConfig) === null || _b === void 0 ? void 0 : _b.belongToSecondFieldLabel)
                    ? (_d = (_c = field === null || field === void 0 ? void 0 : field.metaData) === null || _c === void 0 ? void 0 : _c.addConfig) === null || _d === void 0 ? void 0 : _d.belongToSecondFieldLabel
                    : 'name']
                : '';
                        ...
                        if (_this.resource.detailConfig.tabsConfig &&
                                ...
                                tab.datas.forEach(function (elt) {
                                    ...
                                    switch (temp[search.name].restField.type) {
                                        ...
                                        case exports.REST_FIELD_TYPES.BELONG_TO_MANY:
                                            ...
                                            break;
                                        case exports.REST_FIELD_TYPES.BELONG_TO:
                                            var belongVal = (_p = (_o = search.metaData) === null || _o === void 0 ? void 0 : _o.detailConfig) === null || _p === void 0 ? void 0 : _p.belongToSecondFieldLabel.split('.');
                                            var dat_1 = response;
                            ...
                            _this.resource.fields.forEach(function (elt) {
                                ...
                                if (elt.type === exports.REST_FIELD_TYPES.BELONG_TO) {
                                    var belongVal = (_b = (_a = elt.metaData) === null || _a === void 0 ? void 0 : _a.detailConfig) === null || _b === void 0 ? void 0 : _b.belongToSecondFieldLabel.split('.');
                                    var dat_2 = response;
                                    if (belongVal && (belongVal === null || belongVal === void 0 ? void 0 : belongVal.length) > 0) {
                                        belongVal.forEach(function (val) {
                                            dat_2 = dat_2[val];
    ...
    RestAdminModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.1.5", ngImport: i0__namespace, type: RestAdminModule, declarations: [RestResourceListComponent,
            ...
            FsIconCComponent,
            LoginComponent,
            AttributeDirective], imports: [i9.CommonModule,
            ...
            i8.NgxDropzoneModule, i5__namespace$1.NgxPermissionsModule, i1$1.NbSelectModule,
